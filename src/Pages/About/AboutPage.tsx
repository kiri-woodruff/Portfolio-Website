...
const AboutPage = () => {
    return (
        <motion.div className='about-page' initial={{opacity:0, x:100}} animate={{opacity:1, x:0}} exit={{opacity:0, x: -100}} transition={{duration: 0.5}} >
            <HelmetProvider>
                <Helmet>
            ...
            <div className='about-page-content'>
                ...
                <div className='about-me'>
                    ...
                    At the Digital Corps, I am currently a Development Specialist and a Junior Project Manager.
                    </p>
                </div>
            </div>
        </motion.div>
